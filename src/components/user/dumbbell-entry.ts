...
export class DumbbellEntry extends PolymerElement {
  ...
  static get template() {
    ...
    <paper-slider snaps value="{{dumbbellSliderIndex}}" id="dumbbellSlider" immediate-value="{{dumbbellSliderIndex}}" min="0" max="[[maxDumbbellIndex]]"></paper-slider>
    `;
  }
}
